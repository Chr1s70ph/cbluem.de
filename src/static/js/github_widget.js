...
window.tarptaeya.reloadRepoCards = async function() {
  ...
  const emojis = await fetch('static/data/github_emojis.json').then(resp => resp.json());
  const colors = await fetch('static/data/github_colors.json').then(resp => resp.json());
